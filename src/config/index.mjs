...
export const chatgpt4vApiModelKeys = ['chatgptApi4_v_preview']
...
export const Models = {
  ...
  // },
  chatgptApi4_8k: { value: 'gpt-4-turbo', desc: 'ChatGPT-4 (GPT-4-turbo)' },
...
export const defaultConfig = {
  ...
  themeMode: 'light',
  /** @type {keyof Models}*/
  modelName: 'chatgptApi4_v_preview',

  preferredLanguage: getNavigatorLanguage(),
  // clickIconAction: 'popup',summarizePage
  clickIconAction: 'summarizePage',
  ...
  apiKey: '',
  initialCallBack: 'Hi, I am VizChat. How can I help you today?',
  azureApiKey: '',
  azureEndpoint: '',
  azureDeploymentName: '',
  ...
  activeApiModes: ['chatgptFree35', 'chatgptApi35', 'chatgptApi4_8k', 'chatgptApi4_v_preview'],
...
export async function getContextInfo() {
  ...
  // console.log("getted user config", userConfig)
  // console.log("userConfig.imageInterpretationContext", userConfig.imageInterpretationContext)
  // console.log("userConfig.imageInterpretationContext !== ''", userConfig.imageInterpretationContext !== '')

  if (!(userConfig.imageInterpretationContext && userConfig.imageInterpretationContext !== ''))
    return ''

  return "Here is additional context information: '" + userConfig.imageInterpretationContext + "'"
}
/**
